        ...
        () => {
          ...
          a = function () {
            function e(t) {
              ...
              for (var s = t.classList, l = 0; l < s.length; l++) s[l].startsWith('bg-') &&
              (this._menuBgClass = s[l]);
              t.setAttribute('data-bg-class', this._menuBgClass),
              this._horizontal &&
              window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT ? this.switchMenu('vertical') : this._bindEvents(),
              t.menuInstance = this
            }
            return t = e,
            n = [
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  void 0 !== arguments[1] ? arguments[1] : this._closeChildren,
                  o = this._findUnopenedParent(e._getItem(t, !0), i);
                  if (o) {
                    var r = e._getLink(o, !0);
                    e._promisify(this._onOpen, this, o, r, e._findMenu(o)).then(
                      (
                        function () {
                          n._horizontal &&
                          e._isRoot(o) ? (
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  e._promisify(this._onClose, this, r, s, e._findMenu(r), o).then(
                    (
                      function () {
                        if (n._horizontal && e._isRoot(r)) n._toggleDropdown(!1, r, i),
                        n._onClosed &&
                        n._onClosed(n, r, s, e._findMenu(r));
                         else if (n._animate && !n._horizontal) window.requestAnimationFrame((function () {
                          return n._toggleAnimation(!1, r, i)
                        }));
                         else {
                          if (r.classList.remove('open'), i) for (
              ...
              },
              {
                ...
                value: function (t, n, i) {
                  ...
                  if (t) {
                    ...
                    c > d &&
                    (
                      o.style[this._rtl ? 'marginRight' : 'marginLeft'] = '-'.concat(c - d, 'px')
                    ),
                    this._closeOther(r, i),
                    this._updateSlider()
                  } else {
                    var h = e._findChild(n, [
                      'menu-toggle'
                    ]);
                    if (
                      h.length &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  i = this._innerWidth;
                  'next' === e ? i + (t = this._getSlideNextPos()) < n &&
                  (t = n - i) : (t = this._getSlidePrevPos()) > 0 &&
                  (t = 0),
              ...
              },
              {
                ...
                value: function (t, n) {
                  for (var i = [], o = null; t; ) t.classList.contains('disabled') ? (o = null, i = []) : (t.classList.contains('open') || (o = t), i.push(t)),
                  t = e._findParent(t, 'menu-item', !1);
                  if (!o) return null;
                  if (1 === i.length) return o;
                  for (var r = 0, s = (i = i.slice(0, i.indexOf(o))).length; r < s; r++) if (i[r].classList.add('open'), this._accordion) for (
                    ...
                    a < u;
                    a++
                  ) if (l[a] !== i[r] && (l[a].classList.remove('open'), n)) for (
              ...
              },
              {
                ...
                value: function (t, n, i) {
                  ...
                  t ? (
                    ...
                    e._bindAnimationEndEvent(
                      n,
                      (
                        function () {
                          if (n.classList.remove('open'), a(), i) for (
              ...
              },
              {
                key: '_getItemOffset',
                value: function (e) {
                  for (var t = this._inner.childNodes[0], n = 0; t !== e; ) t.tagName &&
              ...
              },
              {
                key: '_innerWidth',
                get: function () {
                  for (var e = this._inner.childNodes, t = 0, n = 0, i = e.length; n < i; n++) e[n].tagName &&
              ...
              },
              {
                ...
                value: function () {
                  for (
                    var e = arguments.length > 0 &&
                    void 0 !== arguments[0] ? arguments[0] : this._closeChildren,
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (window.innerWidth < window.Helpers.LAYOUT_BREAKPOINT) null !== this._scrollbar &&
            ...
            o = [
              ...
              },
              {
                ...
                value: function (e, t) {
                  for (var n = e.childNodes, i = [], o = 0, r = n.length; o < r; o++) if (n[o].classList) {
                    for (var s = 0, l = 0; l < t.length; l++) n[o].classList.contains(t[l]) &&
                    (s += 1);
                    t.length === s &&
                    i.push(n[o])
                  }
              ...
              },
              {
                key: '_findMenu',
                value: function (e) {
                  for (var t = e.childNodes[0], n = null; t && !n; ) t.classList &&
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  void 0 !== arguments[1] ? arguments[1] : window.Helpers.ROOT_EL,
                  n = !1;
              ...
              },
              {
                ...
                value: function (t, n) {
                  ...
                  if (
                    t.classList.contains('menu-item') ? e._findChild(t, [
                      o
                    ]).length &&
                    (i = t) : t.classList.contains(o) &&
                    (
