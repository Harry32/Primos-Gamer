! function(t, e) {
    ...
    function $(t) {
        ...
        return e.transformRule = a ? "transform" : o ? "msTransform" : "webkitTransform", e.style = [
            ["left", "top"],
            ["right", "bottom"]
        ][e.dir][e.ort], e
    }
    ...
    function G(r, n, i) {
        ...
        function B() {
            b && (rt("update" + w), b.forEach((function(t) {
                t && o(t)
            })), b = null)
        }

        function q() {
            B(), b = f.map(R), et("update" + w, (function(t, e, r) {
                ...
                return d(a, n.cssClasses.pips), d(a, 0 === n.ort ? n.cssClasses.pipsHorizontal : n.cssClasses.pipsVertical), Object.keys(t).forEach((function(o) {
                    ! function(t, o, s) {
                        if ((s = r ? r(o, s) : s) !== e.None) {
                            var l = z(a, !1);
                            l.className = f(s, n.cssClasses.marker), l.style[n.style] = t + "%", s > e.NoValue && ((l = z(a, !1)).className = f(s, n.cssClasses.value), l.setAttribute("data-value", String(o)), l.style[n.style] = t + "%", l.innerHTML = String(i.to(o)))
                        }
                    }(o, t[o][0], t[o][1])
                })), a
            }(i, o, s))
        ...
        function G(t, e, r, i) {
            var o = function(o) {
                    ...
                    return !!l && !(T() && !i.doNotReject) && (s = N, a = n.cssClasses.tap, !((s.classList ? s.classList.contains(a) : new RegExp("\\b" + a + "\\b").test(s.className)) && !i.doNotReject) && !(t === y.start && void 0 !== l.buttons && l.buttons > 1) && (!i.hover || !l.buttons) && (C || l.preventDefault(), l.calcPoint = l.points[n.ort], void r(l, i)))
                },
                s = [];
        ...
        function J(t) {
            var e, r, i, o, s, a, u = 100 * (t - (e = l, r = n.ort, i = e.getBoundingClientRect(), s = (o = e.ownerDocument).documentElement, a = m(o), /webkit.*Chrome.*Mobile/i.test(navigator.userAgent) && (a.x = 0), r ? i.top + a.y - s.clientTop : i.left + a.x - s.clientLeft)) / W();
        ...
        function Z(t, e) {
            ...
            })), 0 === U && (h(N, n.cssClasses.drag), lt(), t.cursor && (L.style.cursor = "", L.removeEventListener("selectstart", a))), n.events.smoothSteps && (e.handleNumbers.forEach((function(t) {
                ut(t, A[t], !0, !0, !1, !1)
        ...
        function tt(t, e) {
            if (!e.handleNumbers.some(_)) {
                ...
                i.push.apply(i, o.concat(s, l)), t.cursor && (L.style.cursor = getComputedStyle(t.target).cursor, f.length > 1 && d(N, n.cssClasses.drag), L.addEventListener("selectstart", a, !1)), e.handleNumbers.forEach((function(t) {
                    nt("start", t)
                }))
            }
        }
        ...
        function it(t, e, r, i, o, s, a) {
            var l;
            return f.length > 1 && !n.events.unconstrained && (i && e > 0 && (l = P.getAbsoluteDistance(t[e - 1], n.margin, !1), r = Math.max(r, l)), o && e < f.length - 1 && (l = P.getAbsoluteDistance(t[e + 1], n.margin, !0), r = Math.min(r, l))), f.length > 1 && n.limit && (i && e > 0 && (l = P.getAbsoluteDistance(t[e - 1], n.limit, !1), r = Math.min(r, l)), o && e < f.length - 1 && (l = P.getAbsoluteDistance(t[e + 1], n.limit, !0), r = Math.max(r, l))), n.padding && (0 === e && (l = P.getAbsoluteDistance(0, n.padding[0], !1), r = Math.max(r, l)), e === f.length - 1 && (l = P.getAbsoluteDistance(100, n.padding[1], !0), r = Math.min(r, l))), a || (r = P.getStep(r)), !((r = c(r)) === t[e] && !s) && r
        }
        ...
        function ut(t, e, r, i, o, s) {
            return o || (e = it(A, t, e, r, i, !1, s)), !1 !== e && (function(t, e) {
        ...
        function ft(t, e, r) {
            var i = p(t),
                o = void 0 === A[0];
            e = void 0 === e || e, n.animate && !o && u(N, n.cssClasses.tap, n.animationDuration), k.forEach((function(t) {
                ut(t, pt(i[t], t), !0, !1, r)
            }));
        ...
        d(S = N, n.cssClasses.target), 0 === n.dir ? d(S, n.cssClasses.ltr) : d(S, n.cssClasses.rtl), 0 === n.ort ? d(S, n.cssClasses.horizontal) : d(S, n.cssClasses.vertical), d(S, "rtl" === getComputedStyle(S).direction ? n.cssClasses.textDirectionRtl : n.cssClasses.textDirectionLtr), l = z(S, n.cssClasses.base),
            function(t, e) {
                var r = z(e, n.cssClasses.connects);
                f = [], (g = []).push(F(r, t[0]));
                for (var i = 0; i < n.handles; i++) f.push(H(e, i)), k[i] = i, g.push(F(r, t[i + 1]))
            }(n.connect, l), (x = n.events).fixed || f.forEach((function(t, e) {
                ...
                !1 !== r && (n.events.snap || u(N, n.cssClasses.tap, n.animationDuration), ut(r, e, !0, !0), lt(), nt("slide", r, !0), nt("update", r, !0), n.events.snap ? tt(t, {
                    handleNumbers: [r]
                ...
                if (!1 !== t && 0 !== e && e !== g.length - 1) {
                    var r = f[e - 1],
                        ...
                        s = [r, i],
                        a = [e - 1, e];
                    d(t, n.cssClasses.draggable), x.fixed && (o.push(r.children[0]), o.push(i.children[0])), x.dragAll && (s = f, a = k), o.forEach((function(e) {
                        G(y.start, e, tt, {
                            handles: s,
                            handleNumbers: a,
                            connect: t
            ...
            })), ft(n.start), n.pips && I(n.pips), n.tooltips && q(), rt("update" + E), et("update" + E, (function(t, e, r, i, o) {
                k.forEach((function(t) {
                    var e = f[t],
                        i = it(A, t, 0, !0, !0, !0),
                        s = it(A, t, 100, !0, !0, !0),
        ...
        var mt = {
            destroy: function() {
                for (rt(E), rt(w), Object.keys(n.cssClasses).forEach((function(t) {
                        h(N, n.cssClasses[t])
            ...
            disable: function(t) {
                null != t ? (f[t].setAttribute("disabled", ""), f[t].handle.removeAttribute("tabindex")) : (N.setAttribute("disabled", ""), f.forEach((function(t) {
                    t.handle.removeAttribute("tabindex")
                })))
            },
            enable: function(t) {
                null != t ? (f[t].removeAttribute("disabled"), f[t].handle.setAttribute("tabindex", "0")) : (N.removeAttribute("disabled"), f.forEach((function(t) {
            ...
            updateOptions: function(t, e) {
                ...
                o.forEach((function(e) {
                    void 0 !== t[e] && (n[e] = a[e])
                })), P = a.spectrum, n.margin = a.margin, n.limit = a.limit, n.padding = a.padding, n.pips ? I(n.pips) : Y(), n.tooltips ? q() : B(), A = [], ft(s(t.start) ? t.start : r, e)
            },
            target: N,
            removePips: Y,
            removeTooltips: B,
